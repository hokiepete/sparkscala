object LearningScala3 {;import org.scalaide.worksheet.runtime.library.WorksheetSupport._; def main(args: Array[String])=$execute{;$skip(225); 
  ...
  def upper(s: String) : String = {
      s.toUpperCase
  };System.out.println("""upper: (s: String)String""");$skip(26); 
  println(upper("hello"));$skip(78); 
  
  def transform(s: String, f: String => String) : String ={
      f(s)
  };System.out.println("""transform: (s: String, f: String => String)String""");$skip(41); val res$3 = 
  transform("hello", s => s.toUpperCase);System.out.println("""res3: String = """ + $show(res$3))}
}
